 ...
 */
public class TiXiangXiangQingActivity extends Activity implements View.OnClickListener{
            ...
            case  R.id.tx_queren:
               ...
               if(n.equals("1")||n.equals("2")) {
                   if(zhanghu.equals("")||name.equals("")) {
                       Toast.makeText(TiXiangXiangQingActivity.this, "请输入完整信息", Toast.LENGTH_SHORT).show();
                   }else {
                       driverdrawal();
                   }
               }else {
                                ...
                                if (info.isSuccessful()) {
                                    ...
                                    if (result != null) {
                                        ...
                                        if (list.get("code").equals("0")) {
                                            Toast.makeText(TiXiangXiangQingActivity.this, list.get("msg"), Toast.LENGTH_SHORT).show();
                                            finish();
                                        } else {
                                            Toast.makeText(TiXiangXiangQingActivity.this, list.get("msg"), Toast.LENGTH_SHORT).show();
                                        }
                                    } else {
                                        Toast.makeText(TiXiangXiangQingActivity.this, "服务器连接失败", Toast.LENGTH_SHORT).show();
                                    }
                                }
                            }
                        });
